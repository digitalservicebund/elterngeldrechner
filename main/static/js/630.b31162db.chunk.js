"use strict";
(self["webpackChunk_egr_egr_app"] = self["webpackChunk_egr_egr_app"] || []).push([[630],{
...
function ElterngeldvarianteBadge(_ref){let{variante,className}=_ref;const label=variante?LABELS[variante]:/*#__PURE__*/(0,jsx_runtime.jsx)((Add_default()),{});const variantClassName=CLASS_NAME[variante];return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:classnames_default()("py-8 px-4 rounded text-center font-bold flex items-center justify-center",className,variantClassName),children:label});}const LABELS={BEG:"Basis","EG+":"Plus",PSB:"Bonus",None:"kein Elterngeld"};const CLASS_NAME={BEG:"bg-Basis text-white","EG+":"bg-Plus text-black",PSB:"bg-Bonus text-black",None:"bg-white text-black border-grey border-2"};
...
function Planungsuebersicht(){const data=usePlanungdaten();return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"flex flex-wrap gap-16 *:grow",children:data.map(entry=>/*#__PURE__*/(0,jsx_runtime.jsx)(Elternteil,{...entry},entry.name))});}
