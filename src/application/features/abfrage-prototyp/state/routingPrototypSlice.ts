...
export enum PersonPageRoutes {
  ANGABEN_PERSON = "ANGABEN_PERSON",
  AUSKLAMMERUNGS_GRUENDE = "AUSKLAMMERUNGS_GRUENDE",
  AUSKLAMMERUNGS_ZEITEN = "AUSKLAMMERUNGS_ZEITEN",
  ABFRAGE_TAETIGKEITEN = "ABFRAGE_TAETIGKEITEN",
  DETAILS_TAETIGKEIT = "DETAILS_TAETIGKEIT",
  DETAILS_ANGESTELLT = "DETAILS_ANGESTELLT",
  EINGABE_EINKOMMEN = "EINGABE_EINKOMMEN",
  WEITERE_TAETIGKEIT = "WEITERE_TAETIGKEIT",
  WEITERE_TAETIGKEIT_ART = "WEITERE_TAETIGKEIT_ART",
}
