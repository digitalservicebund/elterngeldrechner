...
export function ElternteilTaetigkeitenAngestelltHauptjobPage() {
  ...
  const currentRoute = Route.ElternteilTaetigkeitenAngestelltHauptjob;
  ...
  const { register, handleSubmit, formState } = useFormWithValidationTracking({
    resolver: zodResolver(TaetigkeitenAngestelltHauptjobSchema),
  ...
  const onSubmit = async (values: TaetigkeitenAngestelltHauptjob) => {
