...
export function ElternteilTaetigkeitenMinijobEinkommenDetailliertPage() {
  ...
  const currentRoute = Route.ElternteilTaetigkeitenMinijobEinkommenDetailliert;
      ...
      <form id={formIdentifier} onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="input-container">
          <div className="text-container">
            <h3>
              Wie viel hat {vorname} im Minijob pro Monat brutto verdient?
            </h3>
            <p>
          ...
          <InfoTextMinijobEinkommen
            question="Wo finde ich das monatliche Brutto für den Mini-Job?"
            finalParagraphAddition="Da die Monate einzeln eingetragen werden, müssen Sie Sonderzahlungen in den betroffenen Monaten selbst herausrechnen."
          />
