export type Bundesland = keyof typeof bundeslandAntragSupportMap;
export type BundeslandAntragSupport =
  (typeof bundeslandAntragSupportMap)[Bundesland];

export function getBundeslandAntragSupportMap() {
  return bundeslandAntragSupportMap;
}

export function getBundeslandAntragSupportByName(bundesland: Bundesland) {
  return { name: bundesland, ...bundeslandAntragSupportMap[bundesland] };
}

const bundeslandAntragSupportMap = {
  "Baden-Württemberg": {
    isSupported: false,
