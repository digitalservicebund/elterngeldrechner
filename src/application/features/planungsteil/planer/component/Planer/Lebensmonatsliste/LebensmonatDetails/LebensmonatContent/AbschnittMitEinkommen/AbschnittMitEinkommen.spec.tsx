...
import { useInformationenZumLebensmonat } from "@/application/features/planungsteil/planer/component/Planer/Lebensmonatsliste/LebensmonatDetails/informationenZumLebensmonat";
import {
...
describe("Abschnitt mit Einkommen", () => {
  beforeEach(async () => {
    vi.spyOn(
      await import("@/application/features/planungsteil/planer/component/Planer/Lebensmonatsliste/LebensmonatDetails/informationenZumLebensmonat"),
