...
export function DatenuebernahmeAntragPage(): ReactNode {
  ...
  const antragsPreview = isProductionEnvironment
    ...
    : `${isStagingEnvironment ? basePath : ""}/images/ganzer-antrag.png`;

  const seitenPreview = isProductionEnvironment
    ...
    : `${isStagingEnvironment ? basePath : ""}/images/seite-planung.png`;
