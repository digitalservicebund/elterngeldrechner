 ...
 * Mutterschutz. Person 1 ist ausschließlich sozialversicherungspflichtig
 * angestellt mit 3.000 € brutto im Monat, Steuerklasse III.
 *
 ...
 * nicht-selbstständige Tätigkeit" ein, um es später gegen den neuen Fluss
 * zu vergleichen. Siehe auch taetigkeitsarten-nur-minijob.spec.tsx,
 * taetigkeitsarten-nur-selbststaendig.spec.tsx und
 * taetigkeitsarten-alle-drei.spec.tsx.
 */
test("Tätigkeitsarten: nur nicht-selbstständige Tätigkeit", async () => {
