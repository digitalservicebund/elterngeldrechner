 ...
 * Mutterschutz. Person 1 hat ausschließlich einen Minijob mit 450 € im
 * Monat. Der aktuelle Fluss hat keine eigene Minijob-Checkbox auf der
 * Tätigkeiten-Seite; ein reiner Minijob wird über "war oder ist angestellt"
 * erfasst und erst auf der folgenden Tätigkeits-Seite als Minijob markiert.
 *
 * Referenzszenario für die Umstellung auf den neuen Einkommensfluss (siehe
 * ElternteilTaetigkeitenAbfragePageNew), die eine eigene hatMinijob-Checkbox
 * einführt. Friert das Ergebnis für "nur Minijob" ein, um es später gegen
 * den neuen Fluss zu vergleichen. Siehe auch
 * taetigkeitsarten-nur-angestellt.spec.tsx,
 * taetigkeitsarten-nur-selbststaendig.spec.tsx und
 * taetigkeitsarten-alle-drei.spec.tsx.
 */
test("Tätigkeitsarten: nur Minijob", async () => {
  ...
  // Finanzielle Situation Person 1: nur angestellt (Minijob wird erst auf der
  // nächsten Seite als solcher markiert)
  await user.click(
  ...
  // Tätigkeit Person 1 (Minijob): Einkommen gleich verteilt?
  await user.click(
