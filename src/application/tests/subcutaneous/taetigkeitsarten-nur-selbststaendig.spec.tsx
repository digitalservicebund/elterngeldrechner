 ...
 * Mutterschutz. Person 1 ist ausschließlich selbstständig mit 20.000 €
 * Gewinn im gesamten Kalenderjahr.
 *
 * Referenzszenario für die Umstellung auf den neuen Einkommensfluss (siehe
 * ElternteilTaetigkeitenAbfragePageNew): friert das Ergebnis für "nur
 * selbstständige Tätigkeit" ein, um es später gegen den neuen Fluss zu
 * vergleichen. Siehe auch taetigkeitsarten-nur-angestellt.spec.tsx,
 * taetigkeitsarten-nur-minijob.spec.tsx und
 * taetigkeitsarten-alle-drei.spec.tsx.
 */
test("Tätigkeitsarten: nur selbstständige Tätigkeit", async () => {
  ...
  // Tätigkeit Person 1: Sozialversicherungen (kein Minijob-Zwischenschritt
  // für Selbstständige)
  await user.click(
