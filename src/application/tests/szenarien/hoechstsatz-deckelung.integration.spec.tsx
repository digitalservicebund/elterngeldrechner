 ...
 *
 * Beide sind angestellt, Steuerklasse IV, gesetzlich kranken-, renten- und
 * arbeitslosenversichert, nicht kirchensteuerpflichtig. Person 1 verdient
 * 4.600 € brutto im Monat und war vor der Geburt im Mutterschutz,
 * Person 2 verdient 2.500 € brutto.
 *
 * Das hohe Einkommen von Person 1 führt dazu, dass das Basiselterngeld auf den
 * gesetzlichen Höchstbetrag von 1.800 € gedeckelt wird (§ 2 Abs. 1 Satz 1 BEEG);
 * ElterngeldPlus beträgt höchstens die Hälfte, also 900 € (§ 4a BEEG).
 *
 * Person 2 erhält bei 2.500 € brutto 1.088 € Basis
 * bzw. 544 € Plus. Die ersten zwei Lebensmonate von Person 1 sind wegen des
 * Mutterschutzes blockiert (§ 3 BEEG).
 */
test("Höchstsatz-Deckelung: Basiselterngeld wird bei hohem Einkommen auf 1.800 € gedeckelt (§ 2 Abs. 1 BEEG)", async () => {
