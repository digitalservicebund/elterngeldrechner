    ...
    <>
      ...
      >
        <ul className="list-disc">
          ...
          <li>
            Auch Alleinerziehende haben Anspruch auf die Partnermonate, wenn sie
            Elterngeld beantragen
          </li>
          <li>
            Zum Beispiel können Sie 7 Monate Basiselterngeld für sich und 7
            Monate Basiselterngeld für den anderen Elternteil beantragen oder 14
            Monate Basiselterngeld, wenn Sie alleinerziehend sind
          </li>
        </ul>
      </DetailsElterngeldvariante>
