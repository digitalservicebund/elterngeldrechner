...
export function Sidebar({ currentStep }: Props) {
  ...
  const twClasses = {
    navbar: "m-0 list-none p-0 max-[1170px]:mb-40",
    navbarActivatorLarge: "hidden text-nowrap px-24 py-16",
    navbarActivatorSmall:
      "max-[1170px]:flex max-[1170px]:w-full max-[1170px]:items-center max-[1170px]:justify-between max-[1170px]:border-none max-[1170px]:bg-primary-light max-[1170px]:text-black",

    menuBase: "counter-item-reset m-0 list-none p-0",
    menuClosed: "max-[1170px]:invisible max-[1170px]:absolute",
    menuOpen:
    ...
    stepCurrent:
      "before:border-2 before:border-primary before:bg-primary-light max-[1170px]:before:bg-white",
