...
export function determineDeadlineForGeschwisterbonus(
  geschwister: Kind[],
  geburtsdatum: Date,
): Date | null {
  return (
...
export function ende_bonus_u6(geschwister: Kind[]): Date | undefined {
...
export function ende_bonus_u14(geschwister: Kind[]): Date | undefined {
...
export function ende_bonus_u3(geschwister: Kind[]): Date | undefined {
